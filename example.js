...
// Pass the private key to example.js with the Blocase server admin key:
// ####################
...
if (!process.argv[2]) {
  ...
  console.log('Usage: node example.js <root_private_key>')
  process.exit(1)
}
...
const permission = {
  ...
  'collectionsReadOverride': ['default', 'collection2', 'new1']
}
